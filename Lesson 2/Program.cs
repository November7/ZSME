...
class App
{
    ...
    {        
        ...
        // Console.WriteLine(imie,nazwisko); // błędne użycie metody WriteLine (pierwszy argument to tekst formatowany, kolejne są opcjonalne, jako argumenty tekstu formatowanego)
        ...
        // Console.WriteLine("{0} {1} \"{1}\"",imie,nazwisko); //każdy kod w postaci {nr} musi odpowiadać kolejnemu argumentowi, w przeciwnym wypadku nastąpi wyjątek
