class Vehicle:
    ...
    # @staticmethod
    def get_count():
        """Zwraca liczbę utworzonych pojazdów."""
        return Vehicle.count

    @classmethod
    def from_string(cls, text):
        """Tworzy pojazd z tekstu: 'Toyota;Corolla;2018;120000'."""
        brand, model, year, mileage = text.split(";")
...
# Tworzenie z tekstu
v2 = Vehicle.from_string("Honda;Civic;2015;90000")
show_vehicle(v2)
print("Liczba pojazdów:", Vehicle.get_count())
